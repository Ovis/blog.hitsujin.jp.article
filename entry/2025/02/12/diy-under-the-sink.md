...
![シンク下の汚れ](under-the-sink-yogore.png)
![床板が腐ってる](under-the-sink-yukaita_boroboro.png)
...
![アルミ複合板](aluminum-composite-plate.png)
...
![流し排水栓](sink-drainpipe-tap.png)

### 流し排水栓の交換

![排水栓の説明](sink-drainpipe-tap-detail.png)

まずは排水栓の交換から。  
商品の箱に取り付け方の記載があったのでその通りに。  

先に排水ホースを本体から取り外します。  
![排水ホースを取り外す](remove-drain-hose.png)
...
![排水栓の取り外し](remove-drainpipe-tap.png)

排水栓を取り外したところ。  
排水栓のパッキンがシンクにべったりくっついてボロボロに。錆も出てる状況。  
きれいに汚れなどは取り除いておきます。  
後述しますがこのときに排水口に小さな穴（ピンホール）が開いていないか確認しておきましょう。  
![排水栓を取り外した表側](after-remove-drainpipe-tap-1.png)
![排水栓を取り外した裏側](after-remove-drainpipe-tap-2.png)
![古いパッキンなどを取り外したところ](after-remove-drainpipe-tap-3.png)

新しい本体から口金を取り外します。  
本体側の灰色の物体はスベリパッキン。紙製。  

![新しい排水栓](new-drainpipe-tap.png)

新しいパッキンを取り付けて口金を置き、裏から本体を取り付けます。  
![新しいパッキン](new-packing.png)
![本体取付](install-drainpipe-tap-body.png)

取付が終わったら本体に排水ホースを取り付け。  
長すぎたので適当な長さでカットしました。  

![新しい排水ホースと排水パッキン](new-hose.png)
![排水ホースカット](cut-hose.png)

本体にホースを取り付けてから排水プレート（以前のものを再利用した）をはめて、新品の防臭キャップを取り付けて排水パイプに取り付け。  

![排水プレート取付](install-drainpipe-plate.png)
![排水パイプに取り付け](install-drainpipe-pipe.png)
...
![アルミ複合板カット](cut-aluminium-plate-1.png)

サイズ確認のために一度はめ込んだところ。  
まだ排水栓用の穴はあけてません。  
レーザー距離計を使って計測したのでほとんど狂いなくカットできた模様。 
![仮取付](temporary-insert-board-1.png)
...
![目印の穴あけ](drilling-1.png)

![ホールソーで穴を開ける](drilling-2.png)

![開け終わり](drilling-3.png)

ホールソーで空けた穴はバリがついていて危ないので、これまた暗渠排水を作る際に排水パイプの面取りで使ったスクレーパーを使ってバリ取りをしておきました。  

[amazon:B00TO9PJF4]

![面取りスクレーパー](scraper.png)
...
![穴位置確認](temporary-insert-board-2.png)

問題なさそうなので板材を取り付けてしまいます。  
置くだけでも良いんですが、一応両面テープも使うことに。  

![両面テープで固定](install-double-sided-tape.png)

はめ込んだら保護用のビニル材をはがします。  

![保護用ビニールをはがす](peel-off-vinyl.png)

良い感じ。  
分割した以上どうしても隙間が生まれてしまってるんですが、床材の上にニトリで売っている防虫シートを敷くので問題なし。  

![はめ込み完了](insert-board.png)
...
![ピンホール](pin-hole-2.png)

![ピンホール](pin-hole-3.png)
